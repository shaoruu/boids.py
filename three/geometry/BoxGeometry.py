from . import Geometry, QuadGeometry
...
class BoxGeometry(Geometry):
    ...
    def __init__(self, width=2, height=2, depth=2, widthResolution=1, heightResolution=1, depthResolution=1):
        ...
        frontQuad = QuadGeometry(
            width, height, widthResolution, heightResolution)
        ...
        leftQuad = QuadGeometry(
            depth, height, depthResolution, heightResolution)
        ...
        bottomQuad = QuadGeometry(
            width, depth, widthResolution, depthResolution)
