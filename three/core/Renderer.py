    ...
    def render(self, scene, camera, renderTarget=None, clearColor=True, clearDepth=True):
        ...
        if self.shadowMapEnabled:
            ...
            for light in shadowCastLightList:
                ...
                glBindFramebuffer(
                    GL_FRAMEBUFFER, light.shadowRenderTarget.framebufferID)
                glViewport(0, 0, light.shadowRenderTarget.width,
                           light.shadowRenderTarget.height)
        ...
        glClearColor(self.clearColor[0],
                     self.clearColor[1], self.clearColor[2], 1)

        # activate render target
        if (renderTarget == None):
            # set render target to window
            glBindFramebuffer(GL_FRAMEBUFFER, 0)
            glViewport(self.left, self.bottom,
        ...
        for mesh in meshList:
            ...
            camera.uniformList.setUniformValue(
            ...
            for light in lightList:
                ...
                light.uniformList.setUniformValue(
                ...
                if light.shadowCamera is not None:
                    ...
                    light.shadowCamera.uniformList.setUniformValue(
                        "shadowLightDirection", light.getDirection())
