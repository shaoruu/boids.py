...
class Sphere(Shape):
    ...
    def preventOverlap(self, other):
        ...
        distanceLen = math.sqrt(
            distanceVec[0]**2+distanceVec[1]**2+distanceVec[2]**2)

        minTransLen = distanceLen - self.radius - other.radius

        distanceNorm = (
            distanceVec[0]/distanceLen, distanceVec[1]/distanceLen, distanceVec[2]/distanceLen)

        minimumTranslationVector = (-distanceNorm[0]*minTransLen, -
                                    distanceNorm[1]*minTransLen, -distanceNorm[2]*minTransLen)
